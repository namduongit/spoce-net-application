...
-- Thêm dữ liệu phòng
INSERT INTO rooms (room_name, max_computers, type, status) VALUES 
('Phòng chiến thắng', 20, 'Phòng thường', 'Trống'),
...
INSERT INTO mouse(brand, model, purchase_date, warranty_expiry, status) VALUES 
('Logitech', 'Logitech G102', '2025-03-14', '2026-03-14', 'Đang sử dụng'),
...
INSERT INTO keyboards(brand, model, purchase_date, warranty_expiry, status) VALUES 
('Logitech', 'Logitech G Pro X TKL', '2025-03-14', '2027-03-14', 'Đang sử dụng'),
...
INSERT INTO headphones(brand, model, type, purchase_date, warranty_expiry, status) VALUES 
('Logitech', 'Logitech G733', 'Wireless', '2025-03-14', '2026-03-14', 'Đang sử dụng'),
...
INSERT INTO monitors (brand, model, size, refresh_rate, purchase_date, warranty_expiry, status) VALUES 
('ASUS', 'ASUS TUF Gaming VG27AQ', 27.0, 165, '2025-03-14', '2027-03-14', 'Đang sử dụng'),
...
INSERT INTO roms (brand, model, type, capacity, purchase_date, warranty_expiry, status) VALUES 
('AMI', 'AMI BIOS 2023', 'Flash', 32, '2025-03-14', '2027-03-14', 'Đang sử dụng'),
...
INSERT INTO psus (brand, model, wattage, purchase_date, warranty_expiry, status) VALUES 
('Corsair', 'Corsair RM750x', 750, '2025-03-14', '2030-03-14', 'Đang sử dụng'),
...
INSERT INTO storages (brand, model, type, capacity, purchase_date, warranty_expiry, status) VALUES 
('Samsung', 'Samsung 970 EVO Plus', 'NVMe', 1000, '2025-03-14', '2030-03-14', 'Đang sử dụng'),
...
INSERT INTO rams (brand, model, capacity, speed, purchase_date, warranty_expiry, status) VALUES 
...
INSERT INTO gpus (brand, model, vram, purchase_date, warranty_expiry, status) VALUES 
('NVIDIA', 'NVIDIA GTX 1660 Super', 6, '2025-03-14', '2028-03-14', 'Đang sử dụng'),
...
INSERT INTO cpus (brand, model, clock_speed, cores, threads, integrated_gpu, purchase_date, warranty_expiry, status) VALUES 
('AMD', 'AMD Ryzen 5 5600X', 4.6, 6, 12, FALSE, '2025-03-14', '2028-03-14', 'Đang sử dụng'),
...
INSERT INTO motherboards (brand, model, socket, chipset, ram_slots, max_ram, ram_speed, storage_slots, sata_ports, m2_slots, max_storage_capacity, status, cpu_id, psu_id, gpu_id, purchase_date, warranty_expiry) VALUES 
('ASUS', 'ASUS TUF Gaming B550-Plus', 'AM4', 'B550', 4, 128, 4400, 6, 4, 2, 96000, 'Đang sử dụng', 1, 1, 1, '2025-03-14', '2028-03-14'),
...
VALUES ('Máy thường Spoce 1', 10000, 1, 1, 1, 1, 1, 1, 1, 'Đang chờ sử dụng'),
       ('Máy thường Spoce 2', 10000, 2, 2, 2, 2, 2, 2, 1, 'Đang chờ sử dụng'),
       ('Máy thường Spoce 3', 10000, 3, 3, 3, 3, 3, 3, 1,  'Đang chờ sử dụng'),
       ('Máy thường Spoce 4', 10000, 4, 4, 4, 4, 4, 4, 1, 'Đang chờ sử dụng'),
       ('Máy thường Spoce 5', 10000, 5, 5, 5, 5, 5, 5, 1, 'Đang chờ sử dụng'),
       ('Máy vip Spoce 1', 15000, 6, 6, 6, 6, 6, 6, 1, 'Đang chờ sử dụng'),
       ('Máy vip Spoce 2', 15000, 7, 7, 7, 7, 7, 7, 1, 'Đang chờ sử dụng'),
       ('Máy vip Spoce 3', 15000, 8, 8, 8, 8, 8, 8, 1, 'Đang chờ sử dụng'),
       ('Máy vip Spoce 4', 15000, 9, 9, 9, 9, 9, 9, 1, 'Đang chờ sử dụng'),
       ('Máy vip Spoce 5', 15000, 10, 10, 10, 10, 10, 10, 1, 'Đang chờ sử dụng'),
       ('Máy cao cấp Spoce 1', 20000, 11, 11, 11, 11, 11, 11, 1, 'Đang chờ sử dụng'),
       ('Máy cao cấp Spoce 2', 20000, 12, 12, 12, 12, 12, 12, 1, 'Đang chờ sử dụng'),
       ('Máy cao cấp Spoce 3', 20000, 13, 13, 13, 13, 13, 13, 1, 'Đang chờ sử dụng'),
       ('Máy cao cấp Spoce 4', 20000, 14, 14, 14, 14, 14, 14, 1, 'Đang chờ sử dụng'),
       ('Máy cao cấp Spoce 5', 20000, 15, 15, 15, 15, 15, 15, 1, 'Đang chờ sử dụng'),
       ('Siêu máy tính Spoce 1', 30000, 16, 16, 16, 16, 16, 16, 1, 'Đang chờ sử dụng'),
       ('Siêu máy tính Spoce 2', 30000, 17, 17, 17, 17, 17, 17, 1, 'Đang chờ sử dụng'),
       ('Siêu máy tính Spoce 3', 30000, 18, 18, 18, 18, 18, 18, 1, 'Đang chờ sử dụng'),
       ('Siêu máy tính Spoce 4', 30000, 19, 19, 19, 19, 19, 19, 1, 'Đang chờ sử dụng'),
       ('Siêu máy tính Spoce 5', 30000, 20, 20, 20, 20, 20, 20, 1, 'Đang chờ sử dụng');
...
UPDATE roms SET price = CASE
                            ...
                            WHEN model = 'Phoenix SecureCore DXE' THEN 1500000
                            WHEN model = 'Phoenix BIOS 5.0' THEN 1800000
                            WHEN model = 'Phoenix BIOS 4.0' THEN 1700000
                            WHEN model = 'Intel UEFI v3.0' THEN 1600000
                            WHEN model = 'Intel UEFI v2.9' THEN 1500000
                            WHEN model = 'Intel UEFI v2.8' THEN 1400000
                            WHEN model = 'Intel UEFI v2.7' THEN 1300000
                            WHEN model = 'Intel UEFI v2.6' THEN 1200000
                            WHEN model = 'AwardBIOS Elite' THEN 1100000
                            WHEN model = 'Award BIOS Ultra' THEN 1890000
                            WHEN model = 'Award BIOS Pro' THEN 1880000
                            WHEN model = 'Award BIOS Modular' THEN 1870000
                            WHEN model = 'Award BIOS Legacy' THEN 1860000
                            WHEN model = 'AMI BIOS Core' THEN 1850000
                            WHEN model = 'AMI BIOS 2024' THEN 1840000
                            WHEN model = 'AMI BIOS 2023' THEN 1870000
                            WHEN model = 'AMI Aptio V' THEN 1830000
                            WHEN model = 'AMI Aptio 6' THEN 1820000
                            ELSE 0
    END;

UPDATE cpus SET price = CASE
                            WHEN model = 'AMD Ryzen 5 5600X' THEN 4500000
                            WHEN model = 'Intel Core i5-13400' THEN 5500000
                            WHEN model = 'AMD Ryzen 7 7700X' THEN 8500000
                            WHEN model = 'Intel Core i9-13900K' THEN 14500000
                            ELSE 0
    END;

UPDATE storages SET price = CASE
                                WHEN model = 'Samsung 970 EVO Plus' THEN 2500000
                                WHEN model = 'Western Digital WD Black SN850X' THEN 4500000
                                WHEN model = 'Samsung 990 PRO' THEN 3000000
                                WHEN model = 'Seagate FireCuda 530' THEN 2000000
                                WHEN model = 'Crucial P3 Plus' THEN 3500000
                                WHEN model = 'Western Digital WD Black SN770' THEN 2200000
                                WHEN model = 'Seagate BarraCuda 510' THEN 1500000
                                WHEN model = 'Crucial P5' THEN 2300000
                                WHEN model = 'Samsung 980' THEN 1800000
                                WHEN model = 'Crucial P2' THEN 3200000
                                WHEN model = 'Western Digital WD Blue 3D' THEN 1200000
                                WHEN model = 'Crucial MX500' THEN 1400000
                                WHEN model = 'Samsung 870 QVO' THEN 2000000
                                WHEN model = 'Samsung 860 EVO' THEN 1000000
                                WHEN model = 'Crucial BX500' THEN 1100000
                                WHEN model = 'Western Digital WD Green' THEN 1300000
                                WHEN model = 'Seagate Barracuda' THEN 1500000
                                WHEN model = 'Western Digital WD Red' THEN 2000000
                                WHEN model = 'Seagate IronWolf' THEN 2500000
                                WHEN model = 'Seagate Expansion' THEN 1800000
                                ELSE 0
    END;

UPDATE gpus SET price = CASE
                            WHEN model = 'NVIDIA GTX 1660 Super' THEN 5500000
                            WHEN model = 'NVIDIA RTX 3060' THEN 8500000
                            WHEN model = 'NVIDIA RTX 4070' THEN 14500000
                            WHEN model = 'NVIDIA RTX 4090' THEN 45000000
                            ELSE 0
    END;

UPDATE motherboards SET price = CASE
                                    WHEN model = 'ASUS TUF Gaming B550-Plus' THEN 3500000
                                    WHEN model = 'MSI PRO B760M-A' THEN 4000000
                                    WHEN model = 'Gigabyte X670 AORUS Elite' THEN 6500000
                                    WHEN model = 'ASUS ROG Strix Z790-E' THEN 9500000
                                    ELSE 0
    END;

UPDATE mouse SET price = CASE
                             WHEN model = 'Logitech G102' THEN 500000
                             WHEN model = 'Logitech G304' THEN 800000
                             WHEN model = 'Logitech G Pro X Superlight' THEN 3000000
                             WHEN model = 'Logitech G Pro X Superlight 2' THEN 3500000
                             WHEN model = 'Logitech MX Master 3' THEN 2500000
                             WHEN model = 'SteelSeries Rival 3' THEN 600000
                             WHEN model = 'Aerox 5 Wireless' THEN 2000000
                             WHEN model = 'Aerox 3 Wireless' THEN 1800000
                             WHEN model = 'Prime Wireless' THEN 2500000
                             WHEN model = 'Corsair Harpoon RGB' THEN 700000
                             WHEN model = 'Razer Basilisk V3' THEN 1500000
                             WHEN model = 'Razer DeathAdder V2' THEN 1200000
                             WHEN model = 'HyperX Pulsefire Surge' THEN 900000
                             WHEN model = 'Zowie EC2' THEN 1800000
                             WHEN model = 'DareU A950 Pro' THEN 1200000
                             WHEN model = 'DareU A980 Pro Max' THEN 1500000
                             WHEN model = 'DareU A955' THEN 1000000
                             WHEN model = 'DareU EM901X' THEN 800000
                             WHEN model = 'DareU A970' THEN 900000
                             ELSE 0
    END;

UPDATE keyboards SET price = CASE
                                 WHEN model = 'Logitech G Pro X TKL' THEN 3000000
                                 WHEN model = 'Razer BlackWidow V4 Pro' THEN 4500000
                                 WHEN model = 'SteelSeries Apex Pro Mini' THEN 4000000
                                 WHEN model = 'Corsair K95 RGB Platinum' THEN 3500000
                                 WHEN model = 'Keychron K8 Pro' THEN 2000000
                                 WHEN model = 'Ducky One 3 TKL' THEN 2500000
                                 WHEN model = 'Logitech MX Keys' THEN 2500000
                                 WHEN model = 'Raxer Huntsman Mini' THEN 3000000
                                 WHEN model = 'SteelSeries Apex 7 TKL' THEN 2800000
                                 WHEN model = 'Corsair K70 RGB TKL' THEN 3200000
                                 WHEN model = 'DarkAlien R65' THEN 1800000
                                 WHEN model = 'HyperX Alloy Origins 60' THEN 2000000
                                 WHEN model = 'Logitech G915 TKL' THEN 5000000
                                 WHEN model = 'Razer DeathStalker V2' THEN 3500000
                                 WHEN model = 'SteelSeries Apex 3' THEN 1500000
                                 WHEN model = 'Corsair K100 RGB' THEN 4500000
                                 WHEN model = 'Keychron Q1' THEN 3000000
                                 WHEN model = 'Ducky Shine 7' THEN 3500000
                                 WHEN model = 'HyperX Alloy Elite 2' THEN 2500000
                                 WHEN model = 'Logitech G613' THEN 2000000
                                 WHEN model = 'Razer Ornata V3' THEN 1800000
                                 ELSE 0
    END;

UPDATE monitors SET price = CASE
                                WHEN model = 'ASUS TUF Gaming VG27AQ' THEN 7000000
                                WHEN model = 'Dell Alienware AW2723DF' THEN 15000000
                                WHEN model = 'LG UltraGear 27GP950-B' THEN 12000000
                                WHEN model = 'Samsung Odyssey G7' THEN 13000000
                                WHEN model = 'Acer Predator XB273U' THEN 14000000
                                WHEN model = 'ASUS ROG Swift PG259QN' THEN 16000000
                                WHEN model = 'Dell S2721DGF' THEN 8000000
                                WHEN model = 'LG UltraGear 32GP850-B' THEN 11000000
                                WHEN model = 'Samsung Odyssey Neo G8' THEN 20000000
                                WHEN model = 'Acer Nitro XV272U' THEN 7500000
                                WHEN model = 'MSI Optix MAG274QRF-QD' THEN 9000000
                                WHEN model = 'ASUS ROG Strix XG27UCS' THEN 8500000
                                WHEN model = 'Dell Alienware AW3423DWF' THEN 25000000
                                WHEN model = 'LG UltraGear 24GN650-B' THEN 6000000
                                WHEN model = 'Samsung Odyssey G5' THEN 6500000
                                WHEN model = 'Acer Predator X34' THEN 18000000
                                WHEN model = 'MSI Optix MPG321UR-QD' THEN 15000000
                                WHEN model = 'ASUS TUF Gaming VG279QM' THEN 9500000
                                WHEN model = 'Dell G3223Q' THEN 12000000
                                WHEN model = 'LG UltraGear 27GL850-B' THEN 9000000
                                ELSE 0
    END;

UPDATE headphones SET price = CASE
                                  WHEN model = 'Logitech G733' THEN 2500000
                                  WHEN model = 'Razer BlackShark V2' THEN 2000000
                                  WHEN model = 'Sony WH-1000XM5' THEN 8500000
                                  WHEN model = 'HyperX Cloud II' THEN 2000000
                                  WHEN model = 'SteelSeries Arctis Nova Pro' THEN 6000000
                                  WHEN model = 'Sennheiser HD 660S' THEN 9000000
                                  WHEN model = 'Logitech G435' THEN 1500000
                                  WHEN model = 'Razer Kraken V3' THEN 2500000
                                  WHEN model = 'Sony WF-1000XM4' THEN 6000000
                                  WHEN model = 'HyperX Cloud Alpha' THEN 2200000
                                  WHEN model = 'SteelSeries Arctis 7+' THEN 4000000
                                  WHEN model = 'Logitech Zone Vibe 100' THEN 2000000
                                  WHEN model = 'Razer Barracuda X' THEN 2500000
                                  WHEN model = 'Sony MDR-7506' THEN 3000000
                                  WHEN model = 'HyperX Cloud Stinger' THEN 1200000
                                  WHEN model = 'SteelSeries Arctis 1' THEN 1500000
                                  WHEN model = 'Sennheiser Momentum 4' THEN 7500000
                                  WHEN model = 'Logitech G Pro X' THEN 3000000
                                  WHEN model = 'Razer Nari Ultimate' THEN 4000000
                                  WHEN model = 'Sony Pulse 3D' THEN 2500000
                                  ELSE 0
    END;
