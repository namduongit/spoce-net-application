...
VALUES ('Máy thường Spoce 1', 10000.00, 1, 1, 1, 1, 1, 1, 1, 'Đang chờ sử dụng'),
       ('Máy thường Spoce 2', 10000.00, 2, 2, 2, 2, 2, 2, 1, 'Đang chờ sử dụng'),
       ('Máy thường Spoce 3', 10000.00, 3, 3, 3, 3, 3, 3, 1,  'Đang chờ sử dụng'),
       ('Máy thường Spoce 4', 10000.00, 4, 4, 4, 4, 4, 4, 1, 'Đang chờ sử dụng'),
       ('Máy thường Spoce 5', 10000.00, 5, 5, 5, 5, 5, 5, 1, 'Đang chờ sử dụng'),
       ('Máy vip Spoce 1', 15000.00, 6, 6, 6, 6, 6, 6, 1, 'Đang chờ sử dụng'),
       ('Máy vip Spoce 2', 15000.00, 7, 7, 7, 7, 7, 7, 1, 'Đang chờ sử dụng'),
       ('Máy vip Spoce 3', 15000.00, 8, 8, 8, 8, 8, 8, 1, 'Đang chờ sử dụng'),
       ('Máy vip Spoce 4', 15000.00, 9, 9, 9, 9, 9, 9, 1, 'Đang chờ sử dụng'),
       ('Máy vip Spoce 5', 15000.00, 10, 10, 10, 10, 10, 10, 1, 'Đang chờ sử dụng'),
       ('Máy cao cấp Spoce 1', 20000.00, 11, 11, 11, 11, 11, 11, 1, 'Đang chờ sử dụng'),
       ('Máy cao cấp Spoce 2', 20000.00, 12, 12, 12, 12, 12, 12, 1, 'Đang chờ sử dụng'),
       ('Máy cao cấp Spoce 3', 20000.00, 13, 13, 13, 13, 13, 13, 1, 'Đang chờ sử dụng'),
       ('Máy cao cấp Spoce 4', 20000.00, 14, 14, 14, 14, 14, 14, 1, 'Đang chờ sử dụng'),
       ('Máy cao cấp Spoce 5', 20000.00, 15, 15, 15, 15, 15, 15, 1, 'Đang chờ sử dụng'),
       ('Siêu máy tính Spoce 1', 30000.00, 16, 16, 16, 16, 16, 16, 1, 'Đang chờ sử dụng'),
       ('Siêu máy tính Spoce 2', 30000.00, 17, 17, 17, 17, 17, 17, 1, 'Đang chờ sử dụng'),
       ('Siêu máy tính Spoce 3', 30000.00, 18, 18, 18, 18, 18, 18, 1, 'Đang chờ sử dụng'),
       ('Siêu máy tính Spoce 4', 30000.00, 19, 19, 19, 19, 19, 19, 1, 'Đang chờ sử dụng'),
       ('Siêu máy tính Spoce 5', 30000.00, 20, 20, 20, 20, 20, 20, 1, 'Đang chờ sử dụng');
